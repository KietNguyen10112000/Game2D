...
#define PI 3.14159265359f
	...
	public:
		...
		inline Mat4x4& SetRotation(const Vec3& rot)
		{
			XMStoreFloat4x4(this, XMMatrixRotationRollPitchYawFromVector(XMLoadFloat3(&rot)));
			return *this;
		}

		inline Mat4x4& SetRotation(const Vec3& axis, float angle)
		{
			XMStoreFloat4x4(this, XMMatrixRotationAxis(XMLoadFloat3(&axis), angle));
			return *this;
		}
	...
	public:
		...
		inline Mat3x3& SetRotationX(float angle)
		{
			XMStoreFloat3x3(this, XMMatrixRotationX(angle));
			return *this;
		}

		inline Mat3x3& SetRotationY(float angle)
		{
			XMStoreFloat3x3(this, XMMatrixRotationY(angle));
			return *this;
		}

		inline Mat3x3& SetRotationZ(float angle)
		{
		...
		inline Mat3x3& SetPosition(float x, float y)
		{
			_31 = x;
			_32 = y;
			return *this;
		...
		inline Mat3x3& SetPosition(const Vec2& vec)
		{
			_31 = vec.x;
			_32 = vec.y;
			return *this;
